...
((SELECT id FROM listas WHERE nombre = 'Nivel Educativo'), 'Tecnologo', 'Usuario tiene estudios tecnológicos', 4, TRUE, 'admin'),
((SELECT id FROM listas WHERE nombre = 'Nivel Educativo'), 'Pregrado', 'Usuario tiene estudios universitarios', 5, TRUE, 'admin'),
...
-- Usuarios de prueba para insertar en la bd.
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789012', 'Juan Perez', 'juan.perez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789013', 'Carlos Gutierrez', 'carlos.gutierrez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789014', 'Ana Ramirez', 'ana.ramirez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789015', 'Maria Fernandez', 'maria.fernandez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789016', 'Pedro Lopez', 'pedro.lopez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789017', 'Lucia Alvarez', 'lucia.alvarez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789018', 'Diego Martinez', 'diego.martinez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789019', 'Fernanda Suarez', 'fernanda.suarez@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789020', 'Gabriela Torres', 'gabriela.torres@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
INSERT INTO usuarios (identificacion_id, numero_identificacion, nombres, correo, password, telefono, direccion, ciudad_residencia_id, profesion_id, tipo_trabajo_id, estado_civil_id, nivel_educativo_id, ingresos, egresos, genero_id, habilitado, created_at, created_by) VALUES (4, '123456789021', 'Javier Ortega', 'javier.ortega@example.com', '$2a$10$n70LMB19L0yezKtvp94GROEHWM7wpWnMifH5FlUr6lIs0ZkUUMARO', '555-1234', 'Calle 123, Ciudad de Ejemplo', 59, 13, 13, 20, 29, 5000.00, 2000.00, 31, true, CURRENT_TIMESTAMP, 'admin');
...
('Acceso a modulo Roles', 'Permiso para acceder a los endpoints del módulo de Roles', TRUE, (SELECT id FROM valores_listas WHERE valor = 'Roles' LIMIT 1), 'admin'),
('Acceso a modulo Usuarios', 'Permiso para acceder a los endpoints del módulo de Usuarios', TRUE, (SELECT id FROM valores_listas WHERE valor = 'Usuarios' LIMIT 1), 'admin'),
('Acceso a modulo Permisos a Roles', 'Permiso para acceder a los endpoints del módulo de Permisos a Roles', TRUE, (SELECT id FROM valores_listas WHERE valor = 'Permisos a Roles' LIMIT 1), 'admin');

-- Asignar estos permisos al rol administrador
INSERT INTO roles_permisos (rol_id, permiso_id, habilitado) VALUES
((SELECT id FROM roles WHERE nombre = 'Administrador'), (SELECT id FROM permisos WHERE nombre = 'Acceso a modulo Roles'), TRUE),
